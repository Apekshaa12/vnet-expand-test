...
function Calculate-NewSubnetCIDR
{
    ...
    Write-Host "DEBUG: SubscriptionName = '$SubscriptionName'"
    Write-Host "DEBUG: Tenant = '$Tenant'"
    ...
    $ReservedRanges = @()
    $JsonData  = Get-JsonData -jsonFilePath "$SourceDirectory\gha-china-subnet-cidr-calculation\subnet-configuration.json"
